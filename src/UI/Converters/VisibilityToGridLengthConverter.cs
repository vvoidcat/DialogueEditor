...
namespace DialogueEditor.UI.Converters
{
    public class VisibilityToGridLengthConverter : DependencyObject, IValueConverter
    {
        ...
        public static readonly DependencyProperty DefaultSizeProperty =
            ...
            (
                "DefaultSize", 
                typeof(double), 
                typeof(VisibilityToGridLengthConverter),
